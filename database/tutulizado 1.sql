...
INSERT INTO Filiais (Nome, Endereco, Email, Telefone, Quant_mesas, Avaliacao) 
VALUES
('Filial Central', 'Rua Principal, 123', 'central@restaurante.com', '1234-5678', 20, 4.5),
('Filial Norte', 'Av. das Palmeiras, 456', 'norte@restaurante.com', '2345-6789', 15, 4.2),
('Filial Sul', 'Rua do Sol, 789', 'sul@restaurante.com', '3456-7890', 10, 4.0),
('Filial Leste', 'Praça da Liberdade, 101', 'leste@restaurante.com', '4567-8901', 12, 4.3),
('Filial Oeste', 'Av. das Flores, 202', 'oeste@restaurante.com', '5678-9012', 18, 4.4);


INSERT INTO Adm (CPF, Nome, Sexo, Idade, Username, Senha, Endereco, Email, Telefone, Data_cadastro, ID_filial)
VALUES
('12345678901', 'Carlos Oliveira', 'Masculino', '45', 'carlosoliveira', 'senha123', 'Avenida Paulista, 1000', 'carlos.oliveira@email.com', '11912345678', NOW(), 1),
('23456789012', 'Ana Santos', 'Feminino', '32', 'anasantos', 'senha234', 'Rua das Flores, 123', 'ana.santos@email.com', '11923456789', NOW(), 2),
('34567890123', 'Ricardo Lima', 'Masculino', '40', 'ricardolima', 'senha345', 'Rua das Palmeiras, 456', 'ricardo.lima@email.com', '11834567890', NOW(), 3),
('45678901234', 'Mariana Costa', 'Feminino', '28', 'marianacosta', 'senha456', 'Rua dos Jacarandás, 789', 'mariana.costa@email.com', '11745678901', NOW(), 1),
('56789012345', 'Pedro Silva', 'Masculino', '37', 'pedrosilva', 'senha567', 'Rua das Acácias, 101', 'pedro.silva@email.com', '11656789012', NOW(), 2),
('67890123456', 'Juliana Pereira', 'Feminino', '30', 'julianapereira', 'senha678', 'Rua das Orquídeas, 202', 'juliana.pereira@email.com', '11567890123', NOW(), 3),
('78901234567', 'Felipe Almeida', 'Masculino', '33', 'felipealmeida', 'senha789', 'Rua dos Lírios, 303', 'felipe.almeida@email.com', '11478901234', NOW(), 1),
('89012345678', 'Claudia Souza', 'Feminino', '29', 'claudiasouza', 'senha890', 'Rua dos Girassóis, 404', 'claudia.souza@email.com', '11389012345', NOW(), 2),
('90123456789', 'Bruno Martins', 'Masculino', '42', 'brunomartins', 'senha901', 'Rua das Azaleias, 505', 'bruno.martins@email.com', '11290123456', NOW(), 3),
('01234567890', 'Fernanda Rodrigues', 'Feminino', '27', 'fernandarodrigues', 'senha012', 'Rua dos Cravos, 606', 'fernanda.rodrigues@email.com', '11101234567', NOW(), 1);


-- Inserir dados na tabela Clientes
INSERT INTO Usuarios (CPF, Nome, Sexo, Idade, Username, Senha, Endereco, Email, Telefone, Data_cadastro, ID_filial)
VALUES
('12345678901', 'João Silva', 'Masculino', 30, 'joaosilva', 'senha123', 'Rua A, 123', 'joao.silva@email.com', '11987654321', NOW(), 1),
('23456789012', 'Maria Oliveira', 'Feminino', 25, 'mariaoliveira', 'senha456', 'Rua B, 456', 'maria.oliveira@email.com', '11912345678', NOW(), 2),
('34567890123', 'Pedro Santos', 'Masculino', 40, 'pedrosantos', 'senha789', 'Rua C, 789', 'pedro.santos@email.com', '11876543210', NOW(), 1),
('45678901234', 'Ana Costa', 'Feminino', 35, 'anacosta', 'senha321', 'Rua D, 101', 'ana.costa@email.com', '11765432109', NOW(), 3),
('56789012345', 'Lucas Almeida', 'Masculino', 28, 'lucasalmeida', 'senha654', 'Rua E, 202', 'lucas.almeida@email.com', '11654321098', NOW(), 2),
('67890123456', 'Fernanda Lima', 'Feminino', 22, 'fernandalima', 'senha987', 'Rua F, 303', 'fernanda.lima@email.com', '11543210987', NOW(), 3),
('78901234567', 'Carlos Pereira', 'Masculino', 45, 'carlospereira', 'senha654', 'Rua G, 404', 'carlos.pereira@email.com', '11432109876', NOW(), 1),
('89012345678', 'Juliana Ribeiro', 'Feminino', 33, 'julianaribeiro', 'senha321', 'Rua H, 505', 'juliana.ribeiro@email.com', '11321098765', NOW(), 2),
('90123456789', 'Ricardo Martins', 'Masculino', 38, 'ricardomartins', 'senha987', 'Rua I, 606', 'ricardo.martins@email.com', '11210987654', NOW(), 3),
('01234567890', 'Patrícia Souza', 'Feminino', 29, 'patriciasouza', 'senha123', 'Rua J, 707', 'patricia.souza@email.com', '11109876543', NOW(), 1);
